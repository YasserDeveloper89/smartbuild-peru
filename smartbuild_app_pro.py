...
if menu == "Inicio":
    ...
    st.image("https://upload.wikimedia.org/wikipedia/commons/thumb/d/db/Construction_icon.svg/800px-Construction_icon.svg.png", width=150)
...
# Estimación
    ...
    if st.button("Generar Resumen"):
        ...
        st.text_area("Resumen para copiar/exportar", resumen, height=250)

# Reporte
elif menu == "Reporte":
    st.title("Historial de estimaciones")
    st.info("Funcionalidad disponible en una versión futura.")
...
# Acerca de
    ...
    **SmartBuild Perú** es una herramienta creada para facilitar la planificación de proyectos de construcción
    en Perú. Inspirada por el trabajo de Build-Tech y ADR Technology.
